...
**Due Oct 26 --> In class critiques**

**20% of your final grade**

Weekly pushes and development are expected

Pick an adjective and make a program that illustrates that adjective interactively/responsively. You may not use images nor pixels.  Only drawing functions, and things that create graphics. You are to illustrate this adjective over time. Think of it as a performance that unfolds and builds to reveal your adjective. You are to use expressive mark making as your tool.
...
To give you an idea of how much development I'm looking for, your code should be beyond 100 lines of code, which incorporates the concepts we've learned thus far. Spacing, comments or commented out code are not counted as lines.
